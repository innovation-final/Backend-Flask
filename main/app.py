...
# 주식 랭킹
sched.add_job(ranking.renew_ranking_top10, 'cron', day_of_week='mon-fri', hour='9-15', minute='*/2', jitter=60, id='renew_ranking_top10', replace_existing=True)
sched.add_job(ranking.renew_ranking_top100, 'cron', day_of_week='mon-fri', hour='9-15', minute='*/2', jitter=60, id='renew_ranking_top100', replace_existing=True)

# 주식 실시간
sched.add_job(stock_current.renew_stock_data, 'cron', day_of_week='mon-fri', hour='9-15', minute='*/2', id='renew_stock_data', replace_existing=True)
sched.add_job(stock_current.set_expire_at, 'cron', day_of_week='mon-fri', hour='16', id='set_expire_at', replace_existing=True)
